...
class GenerateDocumentFromTemplatePage(BasePageTemplate):
    def __init__(self, context):
        # Khởi tạo BasePageTemplate với tiêu đề và context
        super().__init__("generate_document_from_template", context)
        
        # Xây dựng giao diện trang con tại đây
        # Ví dụ:
        # from ..level_01_atoms.labels import BodyLabel
        # self.desc = BodyLabel("Trang GenerateDocumentFromTemplate đã sẵn sàng.")
