    ...
    def _get_fallback_classic_palette(self) -> dict:
        return {
            "dark": {
                ...
                "PRIMARY_PRESSED": "#a6adc8",
                "ERROR_HOVER": "#f5b0c2",
                "ERROR_PRESSED": "#eba0b3",
                "SELECTED_BG": "rgba(137, 180, 250, 0.15)",
                "DISABLED_BG": "rgba(17, 17, 27, 0.38)",
                "DISABLED_TEXT": "rgba(205, 214, 244, 0.38)",
                "DISABLED_BORDER": "rgba(49, 50, 68, 0.38)",
            },
            "light": {
                "DARK_BG": "#f8f9fa",
                "SIDEBAR_BG": "#e9ecef",
                ...
                "SELECTED_BG": "rgba(79, 70, 229, 0.15)",
                "DISABLED_BG": "rgba(233, 236, 239, 0.5)",
                "DISABLED_TEXT": "rgba(108, 117, 125, 0.5)",
                "DISABLED_BORDER": "rgba(222, 226, 230, 0.5)",
            },
        }
