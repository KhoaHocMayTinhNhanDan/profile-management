...
*   **Hover Effect (Trạng thái rê chuột):** Mọi nút bấm, thẻ thông tin click được, hoặc hàng trong bảng (Table Row) phải thay đổi màu sắc khi con trỏ chuột di qua (tuân thủ quy tắc phủ thêm lớp overlay 8% opacity của chữ/icon lên màu nền gốc được định nghĩa ở quy chuẩn chung).
