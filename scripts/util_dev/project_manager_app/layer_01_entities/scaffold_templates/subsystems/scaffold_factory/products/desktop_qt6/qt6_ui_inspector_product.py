class Qt6UiInspector:
    def get_template(self) -> str:
        return '''from PyQt6.QtCore import QObject, QEvent, Qt, QPoint
...
class UIInspector(QObject):
    ...
    def eventFilter(self, obj, event):
        if self.active and event.type() == QEvent.Type.MouseButtonPress:
            ...
            if widget:
                ...
                while curr:
                    if curr.__class__.__name__ == "NeonMessageBox" or curr.__class__.__name__ == "QMessageBox":
                ...
                from .neon_message_box import NeonMessageBox
                NeonMessageBox.information(
                    widget.window(), 
