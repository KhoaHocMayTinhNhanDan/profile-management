...
@register_strategy("ui/mobile_react_native")
class ReactNativeCompilationStrategy(MobileCompilationStrategy):
    """
    GoF Role: ConcreteStrategy
    Concrete strategy for Mobile React Native platform.
    """

    def is_matching(self, file_path: str) -> bool:
        return "ui/mobile_react_native" in file_path.replace("\\", "/")
