...
from scripts.util_dev.project_manager_app.layer_03_interface_adapters.controllers.desktop.save_project import DesktopSaveProjectController
from scripts.util_dev.project_manager_app.layer_03_interface_adapters.controllers.desktop.load_project import DesktopLoadProjectController
from scripts.util_dev.project_manager_app.layer_03_interface_adapters.controllers.desktop.list_projects import DesktopListProjectsController
from scripts.util_dev.project_manager_app.layer_03_interface_adapters.controllers.desktop.reset_workspace import DesktopResetWorkspaceController
from scripts.util_dev.project_manager_app.layer_03_interface_adapters.controllers.desktop.generate_feature_controller import DesktopGenerateFeatureController
from scripts.util_dev.project_manager_app.layer_03_interface_adapters.controllers.desktop.check_imports_controller import DesktopCheckImportsController
...
from scripts.util_dev.project_manager_app.layer_04_infrastructure.ui.desktop_qt6.services.theme.theme_manager import ThemeManager
from scripts.util_dev.project_manager_app.layer_04_infrastructure.ui.desktop_qt6.services.i18n.i18n_manager import I18nManager
from scripts.util_dev.project_manager_app.layer_04_infrastructure.ui.desktop_qt6.services.light_dark_mode_manager import LightDarkModeManager
...
class AppContextDesktop:
    def __init__(self, project_root: str):
        ...
        self.generate_feature_controller = DesktopGenerateFeatureController(self.generate_feature_interactor)
        self.check_imports_controller = DesktopCheckImportsController(self.check_imports_interactor)
